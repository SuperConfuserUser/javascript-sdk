...
export class BackupGroup {
  ...
  // FIXME: same as backup group update req. IC class descriptions says it's optional, but is JsonRequired
  // should it actually be optional? TimeOfDay | null
  /**
   * Get start time.
   * @returns {TimeOfDay}
   */
   ...
   */
   /* istanbul ignore next: autogenerated */
  async getBackupGroupSummaryStats(): Promise<BackupGroupSummaryStats> {
    return Iland.getHttp().get(`/backup-groups/${this.uid}/summary-stats`).then((response) => {
   ...
   */
  // TODO: further testing. the deleteRequest data shows up in the request payload.
  //  make sure it's being properly implemented w/ our 3rd party
  /* istanbul ignore next: autogenerated */
