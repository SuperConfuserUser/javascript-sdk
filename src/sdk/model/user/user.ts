...
import { O365Job } from '../o365/o365-job';
...
export class User {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getVacCompanies(companyId: string, location?: string): Promise<Array<BaCompany>> {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getO365Organizations(companyId: string, locationId?: string): Promise<Array<O365Organization>> {
    return Iland.getHttp().get(`/users/${this.username}/companies/${companyId}/o365-organizations`, {
      params: {
        location: locationId
      }
    }).then((response) => {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getO365Jobs(companyId: string, locationId?: string): Promise<Array<O365Job>> {
    return Iland.getHttp().get(`/users/${this.username}/companies/${companyId}/o365-jobs`, {
      params: {
        location: locationId
      }
    }).then((response) => {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getO365RestoreSessions(companyId: string, locationId?: string): Promise<Array<O365RestoreSession>> {
    return Iland.getHttp().get(`/users/${this.username}/companies/${companyId}/o365-restore-sessions`, {
      params: {
        location: locationId
      }
    }).then((response) => {
  ...
  // fixme: swagger docs has location string as first optional param.
  //  it doesn't work if no location id is passed. so not optional
  //  also includeDeleted like all other similar listBackupGroup reqs. may be an error?
  /**
   ...
   */
  /* istanbul ignore next: autogenerated */
  async listBackupGroups(companyId: string,
                         location: string,
                         includeSummaryStats?: boolean,
                         includeLastRun?: boolean,
                         includeBackupPolicy?: boolean): Promise<Array<BackupGroup>> {
    return Iland.getHttp().get(`/users/${this.username}/companies/${companyId}/backup-groups`, {
      params: {
        location: location,
